...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RestServiceAnswer.iteration'
        db.add_column(u'restservice_restserviceanswer', 'iteration',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RestServiceAnswer.iteration'
        db.delete_column(u'restservice_restserviceanswer', 'iteration')
    ...
    models = {
        ...
        u'restservice.restserviceanswer': {
            ...
            'iteration': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
