...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attachment.original_name'
        db.add_column(u'odk_logger_attachment', 'original_name',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Attachment.original_name'
        db.delete_column(u'odk_logger_attachment', 'original_name')
    ...
    models = {
        ...
        'odk_logger.attachment': {
            ...
            'original_name': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'})
        },
        'odk_logger.instance': {
